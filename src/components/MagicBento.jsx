...
const DEFAULT_GLOW_COLOR = '255, 106, 0';
...
export const MagicCard = ({
  ...
  }, [animateParticles, clearAllParticles, animationsDisabled, enableTilt, enableMagnetism, clickEffect, glowColor, enableStars]);
  ...
  return (
    <div
      ref={cardRef}
      className={`${baseClassName} ${enableStars ? 'particle-container' : ''}`}
...
export const GlobalSpotlight = ({
  ...
  useEffect(() => {
    if (animationsDisabled || !gridRef?.current || !enabled) return;
  ...
  }, [gridRef, animationsDisabled, enabled, spotlightRadius, glowColor]);
